...
const ROWS: Row[] = [
  ...
  { key: "ambassador_programs", label: "pricing.features.ambassador_programs", group: "pricing.groups.campaigns", format: "bool" },
  { key: "events", label: "pricing.features.events", group: "pricing.groups.campaigns", format: "bool" },
  { key: "open_castings", label: "pricing.features.open_castings", group: "pricing.groups.campaigns", format: "bool" },
  { key: "users", label: "pricing.features.users", group: "pricing.groups.team", format: "number" },
  { key: "multi_environments", label: "pricing.features.multi_environments", group: "pricing.groups.team", format: "bool" },
